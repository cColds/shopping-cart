...
export default function Nav({
  ...
  return (
    <nav className="flex h-[60px] items-center justify-between gap-3 px-4 py-2	shadow-md">
      <Link to="/" aria-label="home page" className="shrink-0">
        <img src={logo} alt="fashonique logo" className="h-[30px] w-[150px]" />
      </Link>
      <button
        type="button"
        className="flex h-[40px] w-[300px] items-center gap-2 rounded-lg border-[1px] border-slate-200 focus:ring-sky-200"
